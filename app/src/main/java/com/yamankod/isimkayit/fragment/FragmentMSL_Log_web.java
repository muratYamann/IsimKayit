...
public class FragmentMSL_Log_web extends  Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
         ...
         rv = inflater.inflate(R.layout.fragment_msl_log_web, container, false);
        ...
        rv.setOnKeyListener(new View.OnKeyListener() {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if( keyCode == KeyEvent.KEYCODE_BACK ) {
                    ...
                    Toast.makeText(getActivity(), "Çıkmak için Monitör ekranına gidip Geri Tusuna Basınız.", Toast.LENGTH_SHORT).show();
